...
class NewNotebookForm extends React.Component {
  ...
  handleSubmit(e) {
    ...
    if (this.props.formType === "new-notebook") {
      ...
      notebook = Object.assign(
        {},
        { id: this.props.notebookId, title: this.state.title }
      );
    }
  ...
  render() {
    ...
    if (this.props.formType === "new-notebook") {
      ...
      subHeaderText = (
        <div className="new-notebook-form-text">
      ...
      <div className="new-notebook-form-container">
        <form onSubmit={this.handleSubmit} className="new-notebook-form">
          ...
          <div className="new-notebook-form-content">
            <div className="new-notebook-form-errors">
              {this.renderErrors()}
            </div>
            <label>
              <div className="new-notebook-form-title-label">
                {formTitleText}
              </div>
            ...
            <div className="new-notebook-form-buttons">
              <div
                ...
                className="white-cancel-button"
              >
                Cancel
              </div>
              <input
                className="white-new-notebook-continue-button"
                type="submit"
                value="Continue"
