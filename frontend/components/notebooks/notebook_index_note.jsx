...
const NotebookIndexNote = props => {
  ...
  return (
    <div
      className={`notebooks-index-item-hover grab ${props.rowSelector(
        props.idx
      )}`}
      draggable="true"
      onDragStart={() => props.drag(props.note.id)}
    >
        ...
        <div className="notebook-item-notes-detail-title-icon-note">
          ...
          >
            <path
              fill="#000"
              fillRule="nonzero"
              d="M8 5a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H8zm8 11h1v-1h-1a.997.997 0 0 0-1 1v2h1v-2zM8 4h8a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm1.5 4a.5.5 0 0 0 0 1h5a.5.5 0 1 0 0-1h-5zm0 3a.5.5 0 1 0 0 1h5a.5.5 0 1 0 0-1h-5zm0 3a.5.5 0 1 0 0 1h3a.5.5 0 1 0 0-1h-3z"
            />
          </svg>
        </div>
        <button onClick={() => openNote(props.note.id)}>
          <div className="notebook-item-notes-detail-title-text">
            {truncateStr(props.note.title, 30)}
          </div>
        </button>
      </div>
      ...
      <div className="notebooks-item-col5 col5">
        <div className="notebook-item-actions">
          ...
          <div
            ...
            onClick={() =>
              dispatch(openNavModal("note-header-nav", props.note.id))
            }
          >
            <svg
              width="16"
