          ...
          <div className='notebooks-list-container'>
            ...
            <div className='notebooks-list-menubar'>
              <div className='notebooks-list-menubar-header'>My notebook list</div>
                ...
                <div className='notebooks-list-menubar-sort-button'>
            ...
            <div className={`notebooks-list-content-ul ${sortOption}`}>
              {notebooks.map((notebook, idx) => <NotebooksIndexItem key={idx} idx={notebook.id} notebook={notebook} deleteNotebook={this.handleDelete} openActionsModal={(navModalId) => this.handleModalClick(navModalId)} />)}
            </div>
