...
class NotebooksIndex extends Component {
  ...
  render() {
    ...
    notebooks.forEach((notebook, idx) => {
      ...
      let notebookRow = (
        <NotebookIndexItem key={notebook.id} idx={idx} notebookId={notebook.id} toggleShowNotes={this.toggleShowNotes} drop={this.drop} allowDrop={this.allowDrop} leaveDropZone={this.leaveDropZone} hoverOverNotebook={this.state.hoverOverNotebook}/>
      );
