  ...
  return (
      <div className='note-header'>
        ...
        <div className='note-actions-menu'>
          ...
          <div className='note-actions-icon' onClick={() => openNavModal('note-header-nav', noteId)(dispatch)}><svg width="18px" height="18px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"></path></svg></div>
        </div>
      </div>
    );
}
